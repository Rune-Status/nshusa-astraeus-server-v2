...
import io.astraeus.net.packet.out.UpdateMapRegion;
...
public final class Movement {
   ...
   */
  private final Stopwatch lock = Stopwatch.start();
  ...
  public final void handleEntityMovement() {
    if (mob.attr.get(Movement.LOCK_MOVEMENT) || lock.elapsed(TimeUnit.MILLISECONDS) <= unlockTime) {
      return;
    }
