...
import io.astraeus.game.sound.Sound;
...
public class SkillSet {
  ...
  private Stopwatch lock = Stopwatch.start();
  ...
  public void addExperience(int skillId, double experience) {
    ...
    if (skill.getMaxLevel() < 99
      ...
      player.startGraphic(Graphic.create(199));
    }
